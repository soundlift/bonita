export default {
  ...
  pages: {
    ...
    records: {
      ...
      viewScrapeLog: "Log",
      noScrapeLog: "No scrape log available",
      scrapeLog: {
        title: "Scrape Log",
        status: "Status",
        running: "Running",
  ...
  components: {
    ...
    task: {
      ...
      form: {
        ...
        scrapingHint: 'If the desired config is not listed, add one in "Scraping Configuration" first',
        enabled: "Enabled",
        optimizeName: "Optimize Folder Name",
        failedFolder: "Failed Folder",
        escapeFolder: "Exclude Folders",
        escapeLiterals: "Exclude Literals",
        escapeSize: "Exclude Size (MB)",
        skipOnSuccess: "Skip scraped records on scan",
        submit: "Submit",
      },
    },
    scraping: {
